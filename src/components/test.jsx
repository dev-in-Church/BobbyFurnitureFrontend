    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-48">
        <DropdownMenuItem asChild>
          <Link to="/category/living-room" className="flex items-center gap-2">
            <Sofa className="h-4 w-4" />
            Living Room
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/category/bedroom" className="flex items-center gap-2">
            <Bed className="h-4 w-4" />
            Bedroom
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/category/dining" className="flex items-center gap-2">
            <Coffee className="h-4 w-4" />
            Dining
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/category/office" className="flex items-center gap-2">
