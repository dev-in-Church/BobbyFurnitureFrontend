...
const SubcategoriesPanel = ({ category, setActiveCategory }) => {
  ...
  return (
    <div
      className="absolute bg-white overflow-y-auto grid grid-cols-3 gap-6 top-0 left-[215px] border border-gray-200 z-50 w-[720px] h-full p-4 rounded-r-sm shadow-md"
...
const HeroSection = () => {
  ...
  return (
    <div className="grid grid-cols-1 w-full h-auto sm:grid-cols-[1fr_3fr_0.95fr] gap-4">
      {/* Categories sidebar - fixed width */}
      <div className="relative hidden md:block bg-white rounded-sm h-full shadow-md ">
